...
TW_NO_CPU_TEMP := true
TARGET_KERNEL_SOURCE := kernel/samsung/msm7627a
TARGET_KERNEL_CONFIG := arubaslim_defconfig
#TARGET_PREBUILT_RECOVERY_KERNEL := device/samsung/arubaslim/kernel
...
#TW_BOARD_CUSTOM_GRAPHICS := ../../../device/samsung/arubaslim/recovery/graphics.c
